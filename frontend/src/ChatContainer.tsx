...
function Gridy({data:{role="",content=""}}, key:string){
    ...
    if(role==="assistant"){
      return (
        <Container key={key} fluid style={{width:"90%", paddingTop:"10px", paddingBottom:"8px", backgroundColor:"transparent", marginLeft: "20px", height: "fit-content", justifySelf:"end"}}>
    ...
    return (
      ...
      <Container key={key} fluid style={{width:"80%", paddingTop:"10px", paddingBottom:"8px", height: "fit-content", justifyContent:"center"}}>
...
const ChatContainer=(props: ComponentProps)=>{
  ...
  for (let index = 0; index < messages.length; index++) {
    chatBubbles.push(<Gridy data={{"role":messages[index]["role"],"content":messages[index]["content"]}} key={messages[index]["key"]} />);
  }
